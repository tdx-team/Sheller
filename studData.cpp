...
#ifdef _WIN64
	m_dwNewSectionAddress64 = (DWORD64)obj_pePe.puGetSectionAddress((char *)m_lpBase, (BYTE *)".UPX");
#else
	m_dwNewSectionAddress = (DWORD)obj_pePe.puGetSectionAddress((char *)m_lpBase, (BYTE *)".UPX");
#endif
...
BOOL studData::CopyStud()
{
	...
	PIMAGE_SECTION_HEADER SurceBase = obj_pePe.puGetSectionAddress((char *)m_lpBase, (BYTE *)".UPX");
